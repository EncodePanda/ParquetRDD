...
class ParquetRDDPartition[T](val index: Int, s: FileSplit, c: Configuration, val readSupport: ReadSupport[T]) extends Partition {
...
class ParquetRDD[T : ClassTag](
  ...
  pathStr: String,
  @transient readSupport: ReadSupport[T] with Serializable
